...
exports = module.exports = internals.Server = function (options) {
    ...
    this._settings = {};
    this._settings.debug = Hoek.applyToDefaults({ request: ['implementation'] }, options.debug);
...
internals.Server.prototype.storage = function (options) {

    var caches = [].concat(options);
...
internals.Server.prototype.server = function (arg1, arg2, arg3) {
    ...
    return this._server(new XXX(arg1, arg2, arg3, this));
};


internals.Server.prototype._server = function (server) {
...
internals.Server.prototype._select = function (labels, subset) {
...
internals.Server.prototype.register = function (plugins /*, [options], callback, _state */) {
...
internals.Server.prototype._register = function (plugins, options, state, callback) {
...
internals.Server.prototype._plugin = function (plugin, registerOptions, state, callback) {
    ...
    var step = function (labels, subset) {
        ...
        var methods = {
            ...
            route: function (options) {
                ...
                self._applySync(selection.servers, XXX.prototype._route, [options, env]);
            },
            state: function () {

                self._applySync(selection.servers, XXX.prototype.state, arguments);
            },
            auth: {
                scheme: function () {
            ...
            ext: function () {
                ...
                self._applySync(selection.servers, XXX.prototype._ext, [arguments[0], arguments[1], arguments[2], env]);
            },
            ...
            register: function (plugins /*, [options], callback */) {
                ...
                internals.Server.prototype._register.call(self, plugins, options, localState, callback);
            }
        };
...
internals.Server.prototype.log = function (tags, data, timestamp, _server) {
...
internals.Server.prototype.start = function (callback) {
    ...
    function (err) {
        ...
        self._invoke('onPreStart', function (err) {
            ...
            self._apply(self._servers, XXX.prototype._start, null, function () {
...
internals.Server.prototype.stop = function (options, callback) {
    ...
    this._apply(this._servers, XXX.prototype._stop, [options], function () {
...
internals.Server.prototype._apply = function (servers, func, args, callback) {
...
internals.Server.prototype._applySync = function (servers, func, args) {
...
internals.Server.prototype._applyChildSync = function (servers, child, func, args) {
...
internals.Server.prototype._provisionCache = function (options, type, name, segment) {
...
internals.Server.prototype._method = function () {

    return this._methods.add.apply(this._methods, arguments);
};


internals.Server.prototype._handler = function (name, fn) {
...
internals.Server.compose = function (manifest /*, [options], callback */) {
    ...
    var pack = new internals.Server(packSettings);
